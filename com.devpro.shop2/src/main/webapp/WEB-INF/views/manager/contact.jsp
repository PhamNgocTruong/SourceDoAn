...
<body>
	<div class="main">
		...
		<div class="content">
			...
			<div class="ds">
				<span><p class="tit"><b>DANH SÁCH LIÊN HỆ</b></p>
				<%-- <a href="${base }/admin/adduser" class="btn btn-back" role="button" 
				style="background-color:black;color:white">Add User</a></span> --%>
				...
				<c:forEach var="contacts" items="${contacts}">
					<tr>
						...
						<a href="${base }/admin/del-user/${users.id}" style="color:red;text-decoration: none" class="delete" onclick="alert('Xóa thành công!')"><span><i class="fas fa-trash-alt"></i>Xóa</span></a>
						
						</td> --%>
						<td>
						<a href="#" style="color:green;text-decoration: none; margin-right: 10px"><span><i class="fas fa-edit"></i>Phản hồi</span></a>
						<a href="#" style="color:red;text-decoration: none"><span><i class="fas fa-trash-alt"></i>Hủy</span></a>
