...
<body>
	...
	<div class="add_product">
		...
		<div class="form-group">
			...
			<sf:input path="size" autocomplete="off" type="text" class="form-control" id="size" placeholder="Size" ></sf:input>
		</div>
		
		<div class="form-group">
			<label for="amount">Amount(required)</label>
			<sf:input path="amount" autocomplete="off" type="text" class="form-control" id="amount" placeholder="Amount" required="required"></sf:input>
		</div>
		...
		<a href="${base }/admin/product" class="btn btn-back" role="button" style="background-color:black;color:white">Quay Lại</a>
