...
<body>
	<div class="main">
		...
		<div class="content">
			...
			<div class="ds">
		<p style="font-size: 24px; background-color: #1d4d83; color: white"><b>Danh sách Sản phẩm</b></p>
		<p>
		<form action="${base }/admin/search-product" method="get">
			<span>
				<input type="text" name="keyword"/>
				<button type="submit" value="Search" >Search</button>
				<a href="${base }/admin/addproduct" class="btn btn-back" role="button" style="background-color:black;color:white">Thêm mới</a>
			...
			<c:forEach var="product" items="${product}">
				<tr>
					...
					<td>
					<a href="${base }/admin/del-product/${product.id}"  style="color:red;text-decoration: none"><span><i class="fas fa-trash-alt"></i>Xóa</span></a>
					<br>
					<a href="${base }/admin/edit-product/${product.seo}" style="color:blue;text-decoration: none"><span><i class="fas fa-edit"></i>Chỉnh sửa</span></a> 
					</td>
