...
<body>
	...
	<div class="page">
				<nav aria-label="Page navigation example">
					  <ul class="pagination">
					    <li class="page-item"><a class="page-link" id="btn_pre" href="${base}/search-product?page=${pagePrev}" >Previous</a></li>
					    <li class="page-item"><a class="page-link" id="btn_pre" href="${base}/search-product?page=1" >1</a></li>
					    <li class="page-item"><a class="page-link" id="btn_pre" href="${base}/search-product?page=2" >2</a></li>
					    <li class="page-item"><a class="page-link" id="btn_pre" href="${base}/search-product?page=3" >3</a></li>
					    <li class="page-item"><a class="page-link" id="btn_next" href="${base}/search-product?page=${pageNext}" >Next</a></li>
					  </ul>
				</nav>
	</div>
