...
<body>
	...
	<div class="section">
		<div class="section-nd">
			...
			<h1>ĐI ĐẾN CỬA HÀNG</h1>
			<a href="${base}/search-product?page=1" class="btn-shop">Mua ngay</a>
		</div>
		<div class="img1">
	...
	<div class="section_2">
		<div class="section-nd2">
			<span>GIẢM 50%</span>
			<h4>MUA HÀNG NGAY THÔI</h4>
			<a href="${base}/search-product?page=1" class="btn-shop">Shop now</a>
		</div>
		<div class="img1">
